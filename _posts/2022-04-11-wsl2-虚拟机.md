...
---
 ...
 WSL2([AMD 上的 Hyper-V 嵌套虚拟化先决条件要求主机操作系统是 Windows 2022 或 Windows 11]([Windows 10, WSL2 enable KVM nested virtualisation on AMD - Linux - Level1Techs Forums](https://forum.level1techs.com/t/windows-10-wsl2-enable-kvm-nested-virtualisation-on-amd/179072))) 使用过的是 Ubuntu 20.04 LTS
...
使用微软 WSL2 专用[内核源码]([GitHub - microsoft/WSL2-Linux-Kernel: The source for the Linux kernel used in Windows Subsystem for Linux 2 (WSL2)](https://github.com/microsoft/WSL2-Linux-Kernel))
...
安装文档参考[官方]([wsl-transdebian | A repository for WSL-only apt packages.](https://arkane-systems.github.io/wsl-transdebian/)[wsl-transdebian | A repository for WSL-only apt packages.](https://arkane-systems.github.io/wsl-transdebian/))
...
网络我是使用默认的可以参考[这里]([libvirt Networking Handbook &mdash; Jamie Nguyen](https://jamielinux.com/docs/libvirt-networking-handbook/index.html))

#### 创建VM

使用的是img 格式的镜像启动 VM [ubuntu-20.04-server-cloudimg-amd64.img]([Ubuntu 20.04 LTS (Focal Fossa) [20220322]](https://cloud-images.ubuntu.com/releases/focal/release/)) 体积比较小。
...
- https://dgideas.net/2020/create-vm-based-on-ubuntu-20-04-and-kvm-cloudinit/[基于 Ubuntu 20.04 系统使用 KVM+CloudInit 创建虚拟机 &#8211; DGideas&#039; Blog](https://dgideas.net/2020/create-vm-based-on-ubuntu-20-04-and-kvm-cloudinit/)
